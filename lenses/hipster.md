...
Decide feasibility. Decide pricing. Invent user needs — those come from the hound.
...
reviewer. Second, ask for three different layouts for the same screen, then throw
away two. Ask for options, not for the answer.
...
---
All hipster artifacts are listed in [INDEX.md](../INDEX.md).
